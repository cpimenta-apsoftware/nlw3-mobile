...
export default function DetalheOrfanato() {
  const route = useRoute();
  const [orfanato, definirOrfanato] = useState<Orfanato>();

  const params = route.params as ParametrosOrfanato;
  ...
  function tratarAberturaRotasGoogleMap() {
    ...
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          {orfanato.imagens.map(imagem => {
            return (
              <Image key={imagem.id} style={styles.image} source={{ uri: imagem.url }} />
            );
          })}
        </ScrollView>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={tratarAberturaRotasGoogleMap} style={styles.routesContainer}>
            <Text style={styles.routesText}>Ver rotas no Google Maps</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {orfanato.horario_atendimento}</Text>
          </View>
